        ...
        <div className='border border-slate-400 p-3'>
            <div className='flex gap-4 flex-wrap justify-between bg-slate-200 rounded p-4'>
                <div>
                    ...
                    <div className='text-[14px] text-primary-light'>{new Date(order.createdAt).toLocaleString()}</div>
                </div>
                <div>
                            ...
                            <table className='text-left [&_tr]:align-top [&_tr]:pr-4 [&_tr]:py-2 [&_td]:py-2 [&_p]:mb-[0.6em] last:[&_p]:mb-0'>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td dangerouslySetInnerHTML={{ __html: order.deliveryFullAddress }}></td>
                                    </tr>
                                    <tr>
                    ...
                    <div className="mt-2">
                        <div className="bg-slate-100 rounded p-4">
                            ...
                            <div className='mt-4 flex items-center justify-between flex-wrap gap-4'>
                                ...
                                <span className='text-[38px] leading-none font-bold text-[#5e616b]'>{addCurrencySymbol(order.totalPrice)}</span>
                            </div>
                        </div>
                    </div>
                </div>
