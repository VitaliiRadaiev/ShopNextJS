...
export function CheckoutForm({ me }: CheckoutFormProps): JSX.Element {
    ...
    const submitHandler = async (formData: FormData) => {
        ...
        await createOrderAction({
            delivery: rawFormData.delivery === 'delivery-pickup' 
                ? 'Самовывоз из Новой Почты' : 'Курьер Новой Почты',
            deliveryFullAddress: `
            ...
            `,
            paymentMethod: rawFormData.paymentMethod === 'C.O.D' 
                ? 'Оплата при получении товара' : 'Оплата на карту VISA/Mastercard',
